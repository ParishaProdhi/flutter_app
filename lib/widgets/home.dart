          ...
          body: SafeArea(
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  child: Text(
                    "আমানত,ঋণ,বৈদেশিক বানিজ্যসহ সব ধরনের আধুনিক ব্যাংকিং কার্যক্রম পরিচালনা করে বাংলাদেশ কৃষি ব্যাংক।গ্রাম-গঞ্জের ১০৩৮টি শাখার মধ্যে অধিকাংশ অন-লাইন শাখার মাধ্যমে বিশ্বের যে কোন দেশের প্রবাসীদের রেমিট্যান্সের টাকা দ্রুততম সময়ে স্বজনদের দোরগোড়ায় পৌঁছে দিচ্ছে।",
                    textAlign: TextAlign.justify,
                  ),
                ),
                SizedBox(
